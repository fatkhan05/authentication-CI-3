            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-password-image"><img src="https://img.freepik.com/premium-vector/flat-design-person-with-mobile-phone-data-security_281090-16.jpg?size=626&ext=jpg" width="470" height="410" alt=""></div>
                            <div class="col-lg-6">
                                <div class="p-5 mt-4">
